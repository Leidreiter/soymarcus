...
const translations = {
  es: {
    ...
    problema1Desc: "Tu marca no está donde están tus clientes: online. Necesitás presencia digital real.",
    problema2Titulo: "Tu web no convierte",
    problema2Desc: "Los visitantes llegan a tu web pero no sabés por qué no contactan ni compran.",
    problema3Titulo: "No aparecés en Google",
    problema3Desc: "Tu sitio existe pero nadie lo encuentra en buscadores ni en Google.",
    ...
    solucion1Desc: "Diseño y desarrollo de webs modernas, responsive y alineadas con tu marca.",
    solucion2Titulo: "Diseño UX/UI pensado en el usuario",
    solucion2Desc: "Interfaces intuitivas con navegación clara y llamados a la acción que convierten.",
    solucion3Titulo: "Optimización SEO y rendimiento",
    solucion3Desc: "Código limpio, velocidad de carga y buenas prácticas SEO para posicionarte mejor.",
  ...
  en: {
    ...
    problema1Desc: "Your brand isn't where your customers are: online. You need digital presence.",
    problema2Titulo: "Your website doesn't convert",
    problema2Desc: "Visitors come to your site but you don't know why they don't contact or buy.",
    problema3Titulo: "You don't appear on Google",
    problema3Desc: "Your site exists but nobody finds it on Google or other search engines.",
    ...
    solucion1Desc: "Modern, responsive websites designed and developed aligned with your brand.",
    solucion2Titulo: "UX/UI design focused on the user",
    solucion2Desc: "Intuitive interfaces with clear navigation and strategic calls to action.",
    solucion3Titulo: "SEO optimization and performance",
    solucion3Desc: "Clean code, fast loading and SEO best practices to rank better on Google.",
