// idiomas.js - Sistema de traducción completo para la web
...
const translations = {
  es: {
    ...
    servicio1Desc: "Diseños visuales únicos que transmiten identidad de marca. Creación de piezas gráficas atractivas y funcionales que generan impacto positivo en tus clientes.",
    servicio2Titulo: "UX / UI Design",
    servicio2Desc: "Interfaces pensadas para la mejor experiencia. Prototipos funcionales, navegación intuitiva y diseño visual coherente para lograr productos fáciles de usar.",
    servicio3Titulo: "Web Design (WordPress)",
    servicio3Desc: "Creación de sitios web profesionales con WordPress, adaptables a dispositivos móviles y optimizados para reflejar la identidad visual de tu marca de manera efectiva.",
    servicio4Titulo: "Ecommerce (WordPress)",
    servicio4Desc: "Tiendas online funcionales y atractivas con WordPress. Integración de pasarelas de pago, catálogo de productos y experiencia de usuario fluida para aumentar tus ventas.",
    servicio5Titulo: "Web Development (code)",
    servicio5Desc: "Desarrollo web a medida utilizando tecnologías modernas. Código limpio y eficiente para sitios que sean rápidos, seguros y escalables que cumplen con los estándares actuales.",
    servicio6Titulo: "Mantenimiento Web",
    servicio6Desc: "Me encargo del mantenimiento completo de tu sitio WordPress: actualizaciones, seguridad, optimización y soporte técnico para que tu web funcione siempre sin problemas.",
    ...
    testimonial1Texto: "Martín es sinónimo de profesionalismo. Cumple los plazos, comunica cada avance y propone soluciones inteligentes ante cualquier imprevisto. Es confiable, organizado y comprometido, cualidades que hoy en día valen oro.",

    testimonial2Nombre: "Daniel Parodi",
    testimonial2Puesto: "CEO & Founder CRECIENDO",
    testimonial2Texto: "Trabajar con Martín fue un antes y un después para nuestra marca. Diseñó una web moderna que refleja perfectamente nuestra identidad visual. Cada color, tipografía y detalle se siente alineado con la esencia de lo que somos y queremos transmitir.",

    testimonial3Nombre: "Guadalupe Pedernera",
    testimonial3Puesto: "Productora Audiovisual & Industrial Designer",
    testimonial3Texto: "Su dominio técnico y criterio estético se complementan de forma natural. No es solo un diseñador o programador: entiende todo, desde la experiencia de usuario hasta la implementación del código, ofreciendo resultados impecables.",

    testimonial4Nombre: "Matías Ochoa",
    testimonial4Puesto: "Marketing & Operations",
    testimonial4Texto: "Desde el primer contacto, Martín se involucró en el proyecto como si fuera suyo. Escucha, propone y se adapta a cada necesidad del cliente. La atención que brinda es tan profesional como los resultados finales.",

    testimonial5Nombre: "Eyal Mustacchi",
    testimonial5Puesto: "Co-founder Agencia PuntoPro",
    testimonial5Texto: "Llevo más de diez años trabajando con diseñadores y desarrolladores, y Martín destaca por la consistencia y calidad de su trabajo. Entrega proyectos que no solo lucen bien: funcionan perfectamente y generan resultados medibles.",

    testimonial6Nombre: "Aldana Carpera",
    testimonial6Puesto: "Co-founder Agencia PulpoWay",
    testimonial6Texto: "Trabajé con Martín en varios proyectos de Pulpo Way y siempre mostró un nivel sobresaliente de compromiso y calidad. Sabe trasladar la identidad de una marca al mundo digital cuidando cada detalle de diseño, funcionalidad y rendimiento. Es un profesional confiable y proactivo.",


    // Portfolio
    portfolioTitulo: "Trabajos",
    portfolio1Titulo: "La Veneciana",
    portfolio1Desc: "Web corporativa sencilla para comunicación de productos y sucursales.",
    portfolio2Titulo: "Margaret Automotores",
    portfolio2Desc: "Web de catálogo de vehículos disponibles con información detallada y contacto.",
    ...
    portfolio4Desc: "Página institucional corporativa con estructura clara y presencia sólida.",
    portfolio5Titulo: "Hola Mundo Store",
    portfolio5Desc: "Web catálogo simil ecommerce para venta de productos vía WhatsApp.",
    portfolio6Titulo: "Tecnocell Company",
    portfolio6Desc: "Catálogo web moderno y usabilidad fluida para toma de pedidos directa.",
    portfolio7Titulo: "Constanza Estevan",
    portfolio7Desc: "Sitio personal con estética cuidada y presentación profesional.",
    portfolio8Titulo: "Aural Sounds",
    portfolio8Desc: "E-commerce musical con foco en su diseño audiovisual y autodaministrable.",
    portfolio9Titulo: "Qunan Arquitectos",
    portfolio9Desc: "Web institucional arquitectónica con diseño limpio y visual potente.",
    portfolio10Titulo: "Eden Agua",
    portfolio10Desc: "Web profesional corporativo: servicios, productos y trayectoria de Eden Agua, Perú.",
    ...
    portfolio13Desc: "Web corporativa para información, contacto y localización de sucursales.",
    ...
    problema1Desc: "Tu marca no tiene una identidad visual que la diferencie y conecte con tu audiencia.",
    problema2Titulo: "No tenés presencia digital",
    problema2Desc: "Tu marca no está donde están tus clientes: online. Necesitás presencia digital real.",
    problema3Titulo: "Tu web no convierte",
    problema3Desc: "Los visitantes llegan a tu web pero no sabés por qué no contactan ni compran.",
    problema4Titulo: "No aparecés en Google",
    problema4Desc: "Tu sitio existe pero nadie lo encuentra en buscadores ni en Google.",
    problema5Titulo: "Querés vender online",
    problema5Desc: "Necesitás un ecommerce pero no sabés por dónde empezar ni cómo vender.",
    problema6Titulo: "No sabés cómo mantenerlo",
    problema6Desc: "Tener una web no es solo crearla, hay que mantenerla viva, segura y actualizada.",

    solucionesTitulo: "Mi solución",
    solucion1Titulo: "Diseño de identidad corporativa",
    solucion1Desc: "Creación de marca completa con logo, paleta cromática y manual de identidad visual.",
    solucion2Titulo: "Creación de sitios web profesionales",
    solucion2Desc: "Diseño y desarrollo de webs modernas, responsive y alineadas con tu marca.",
    solucion3Titulo: "Diseño UX/UI pensado en el usuario",
    solucion3Desc: "Interfaces intuitivas con navegación clara y llamados a la acción que convierten.",
    solucion4Titulo: "Optimización SEO y rendimiento",
    solucion4Desc: "Código limpio, velocidad de carga y buenas prácticas SEO para posicionarte mejor.",
    solucion5Titulo: "Ecommerce funcional y atractivo",
    solucion5Desc: "Tiendas online con carrito, pasarela de pago y productos lista para vender.",
    solucion6Titulo: "Mantenimiento y soporte técnico",
    solucion6Desc: "Actualizaciones, seguridad, backups y soporte continuo para que tu web funcione.",
  ...
  en: {
    ...
    testimonial1Texto: "Martín is synonymous with professionalism. He meets deadlines, communicates every progress and proposes intelligent solutions to any unforeseen event. He is reliable, organized and committed, qualities that are worth gold today.",

    testimonial2Nombre: "Daniel Parodi",
    testimonial2Puesto: "CEO & Founder CRECIENDO",
    testimonial2Texto: "Working with Martín was a before and after for our brand. He designed a modern website that perfectly reflects our visual identity. Every color, typography and detail feels aligned with the essence of who we are and what we want to convey.",
    ...
    testimonial4Nombre: "Matías Ochoa",
    testimonial4Puesto: "Marketing & Operations",
    testimonial4Texto: "From the first contact, Martín got involved in the project as if it were his own. He listens, proposes and adapts to every client need. The attention he provides is as professional as the final results.",

    testimonial5Nombre: "Eyal Mustacchi",
    testimonial5Puesto: "Co-founder PuntoPro Agency",
    testimonial5Texto: "I have been working with designers and developers for over ten years, and Martín stands out for the consistency and quality of his work. He delivers projects that not only look good: they work perfectly and generate measurable results.",

    testimonial6Nombre: "Aldana Carpera",
    testimonial6Puesto: "Co-founder PulpoWay Agency",
    testimonial6Texto: "I worked with Martín on several Pulpo Way projects and he always showed an outstanding level of commitment and quality. He knows how to transfer a brand's identity to the digital world, taking care of every detail of design, functionality and performance. He is a reliable and proactive professional.",
    ...
    problema1Desc: "Your brand has no visual identity that sets it apart and connects with your audience.",
    problema2Titulo: "You have no digital presence",
    problema2Desc: "Your brand isn't where your customers are: online. You need digital presence.",
    problema3Titulo: "Your website doesn't convert",
    problema3Desc: "Visitors come to your site but you don't know why they don't contact or buy.",
    problema4Titulo: "You don't appear on Google",
    problema4Desc: "Your site exists but nobody finds it on Google or other search engines.",
    problema5Titulo: "You want to sell online",
    problema5Desc: "You need an ecommerce but don't know where to start or how to sell.",
    problema6Titulo: "You don't know how to maintain it",
    problema6Desc: "Having a website isn't just creating it, it needs to stay live and secure.",

    solucionesTitulo: "My solution",
    solucion1Titulo: "Corporate identity design",
    solucion1Desc: "Complete brand creation with logo, color palette, typography and identity manual.",
    solucion2Titulo: "Professional website creation",
    solucion2Desc: "Modern, responsive websites designed and developed aligned with your brand.",
    solucion3Titulo: "UX/UI design focused on the user",
    solucion3Desc: "Intuitive interfaces with clear navigation and strategic calls to action.",
    solucion4Titulo: "SEO optimization and performance",
    solucion4Desc: "Clean code, fast loading and SEO best practices to rank better on Google.",
    solucion5Titulo: "Functional and attractive ecommerce",
    solucion5Desc: "Online stores with cart, payment gateway and products ready to sell.",
    solucion6Titulo: "Maintenance and technical support",
    solucion6Desc: "Updates, security, backups and ongoing support so your website always works.",
...
function detectUserLanguage() {
  ...
  // Si el idioma del navegador es español (es, es-ES, es-AR, etc.), retorna 'es'
  // De lo contrario, retorna 'en'
  return browserLang.toLowerCase().startsWith('es') ? 'es' : 'en';
}

// Función para obtener el idioma guardado o detectar el idioma del usuario
...
document.addEventListener('DOMContentLoaded', function () {
  // Configurar el switch de idioma según el idioma inicial
  const languageSwitch = document.getElementById('language-switch');
  if (languageSwitch) {
    // Si el idioma es inglés, marcar el switch
