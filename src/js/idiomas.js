...
const translations = {
  es: {
    ...
    cafeSemanales: "Café semanales",
    
    // Servicios
    misServicios: "Mis Servicios",
    consultar: "Consultar",
    servicio1Title: "🎨 Diseño gráfico",
    ...
    servicio3Title: "💻 Diseño web (WordPress)",
    ...
    servicio4Title: "🛒 Ecommerce (WordPress)",
    ...
    servicio5Title: "👨🏻‍💻 Desarrollo web (código)",
    ...
    servicio6Title: "🛠️ Mantenimiento Web",
    ...
    comoLlegaste: "¿Cómo llegaste a mi web?",
    ...
    // Footer
    derechosReservados: "© 2025 Todos los derechos reservados. Hecho con ♥️ por mi mismo.",
  ...
  en: {
    ...
    servicio3Title: "💻 Web Design (WordPress)",
    ...
    servicio5Title: "👨🏻‍💻 Web Development (code)",
    ...
    servicio6Title: "🛠️ Web Maintenance",
    ...
    // Footer
    derechosReservados: "© 2025 All rights reserved. Made with ♥️ by myself.",
...
function translatePage(lang) {
  ...
  if (numeros.length >= 4) {
    numeros[0].textContent = t.añosExp;
  ...
  if (origenSelect) {
    ...
    options.forEach(opt => {
      ...
      } else if (opt.value === 'recomendacion' || opt.textContent.includes('Recomendación')) {
  ...
  // Actualizar "Años" en edad
  const edadValue = document.querySelector('.informacion .row:last-child .value');
  if (edadValue && edadValue.textContent.includes('Años')) {
    edadValue.textContent = edadValue.textContent.replace('Años', t.años);
  } else if (edadValue && edadValue.textContent.includes('Years')) {
    edadValue.textContent = edadValue.textContent.replace('Years', t.años);
  }
